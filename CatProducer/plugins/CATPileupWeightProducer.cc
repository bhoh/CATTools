...
#include "PhysicsTools/Utilities/src/LumiReWeighting.cc" //BHO
...
CATPileupWeightProducer::CATPileupWeightProducer(const edm::ParameterSet& pset)
{
  ...
  else
  {
    ...
    lumiWeights_ = new edm::LumiReWeighting(pileupMCTmp, pileupRDTmp);   //BHO
    lumiWeightsUp_ = new edm::LumiReWeighting(pileupMCTmp, pileupUpTmp); //BHO
    lumiWeightsDn_ = new edm::LumiReWeighting(pileupMCTmp, pileupDnTmp); //BHO
    if(doPeriodWeights_){
      lumiWeights_periodB_ = new edm::LumiReWeighting(pileupMCTmp, pileupRDTmp_B); //BHO
      lumiWeights_periodC_ = new edm::LumiReWeighting(pileupMCTmp, pileupRDTmp_C); //BHO
      lumiWeights_periodD_ = new edm::LumiReWeighting(pileupMCTmp, pileupRDTmp_D); //BHO
      lumiWeights_periodE_ = new edm::LumiReWeighting(pileupMCTmp, pileupRDTmp_E); //BHO
      lumiWeights_periodF_ = new edm::LumiReWeighting(pileupMCTmp, pileupRDTmp_F); //BHO
      lumiWeights_periodG_ = new edm::LumiReWeighting(pileupMCTmp, pileupRDTmp_G); //BHO
      lumiWeights_periodH_ = new edm::LumiReWeighting(pileupMCTmp, pileupRDTmp_H); //BHO
